> 🗄️ **Archivado el 16-sep-2026.** `_NEXT.md` se retiró en todos los repos: lo que sigue abierto vive en el tablero (http://localhost:8899, tarjetas con fuente `_NEXT · <repo>`). Este archivo es histórico; no se actualiza.
